...
public class ColorPickerDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final boolean showNegativeButton = getArguments().getBoolean(ARG_SHOW_NEGATIVE_BUTTON);
    ...
    public static final class Builder {
        ...
        /**
         * Show/Hide the negative button to dismiss the dialog.
         *
         * @param showNegativeButton {@code false} to disable showing the negative button.
         * @return This builder object for chaining method calls
         */
